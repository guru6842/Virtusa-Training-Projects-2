...
<title>Search teacher page</title>
    ...
    <div> 
        <div class="d-flex flex-col">
            <div class="justify-content-start form-block-sty">
                ...
                <div>
                    <form action="http://localhost:8080/ServletProject//EditTeacher" method="post" >
                        <input type="text" class="form-control" name=PhoneNo placeholder="Enter Phone Number"/><br/>
				    
				        <button class="btn btn-sty" type="submit">Search</button> 
				    </form>
                </div>
            </div>
